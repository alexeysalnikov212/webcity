<div id="register">
	<div class="col-md-offset-4 col-md-4">
		<form class="form-vertical" role="form" method="post" action="index.php?ctrl=company&act=create" accept-charset="UTF-8">
        ...
        <div class="form-group col-md-12">
			...
			<div class="form-group col-md-12">
				 ...
				 <input type="text" class="form-control" name="fullname" placeholder="Название компании/организации" required>
			</div>
			<div class="form-group col-md-12">
			...
			<div class="form-group col-md-12">
				 <label class="sr-only" for="place_id">Адрес</label>
				<div class="input-group">
				 <input type="text" class="form-control" name="place_id" placeholder="Адрес" required>
