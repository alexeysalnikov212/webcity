...
<!-- Данные пользователя -->
  ...
  <div class="container ">
     <div class="clearfix">     
        ...
        <div class="col-lg-12 form-group margin50">
      <label class="col-lg-2"  for="login">Логин</label>
      <div class="col-lg-4">
        <input type="text" id="login" name="login" placeholder="" class="form-control login" value="">
      </div>
    </div>
     
    <div class="col-lg-12 form-group">
      <label class="col-lg-2" for="password">Пароль</label>
      <div class="col-lg-4">
        <input type="password" id="password" name="password" placeholder="" class="form-control password" value="">
      </div>
      <label class="col-lg-2" for="password">Подтверждение пароля</label>
      <div class="col-lg-4">
        <input type="password" id="comfirm" name="comfirm" placeholder="" class="form-control comfirm" value="">
      </div>
    ...
    <div class="col-lg-12 form-group">
      ...
      <div class="col-lg-4">
        <input type="text" id="email" name="email" placeholder="user@mail.com" class="form-control email" value="">
      </div>
    </div>
 
    <div class="col-lg-12 form-group margin50">
				 <label class="col-lg-2" for="photo">Фото</label>
				 <input class="btn btn-default" type="file" class="form-control" name="photo">
  </div>
<div>
    <div class="Product_Button col-lg-offset-6">
        <button type="reset" class="btn btn-primary"><strong>Очистить</strong></button>
        <button type="submit" class="btn btn-primary"><strong>Сохранить</strong></button>
    </div>
</div>
    </div>
    </div>
...
<!-- /Данные пользователя -->
  ...
  <div class="container ">
    ...
    <div class="col-lg-12 form-group">
      <label class="col-lg-2" for="email">Почта</label>
      <div class="col-lg-4">
        <input type="text" id="email" name="email" placeholder="email" class="form-control email" value="">
      </div>
    </div>
    ...
    <div class="col-lg-12 form-group">
      ...
      <div class="col-lg-4">
        <input type="text" id="www" name="www" placeholder="www" class="form-control www" value="">
      </div>
    </div>
